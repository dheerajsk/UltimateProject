...
namespace UltimateProject.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        /// 
        /// </summary>
        /// <param name="companyId">companyId parameter in action will be mapped from main route, hence no need to add route in HttpGet attribute</param>
        /// <returns></returns>
        [HttpGet]
